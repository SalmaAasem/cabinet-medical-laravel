        ...
        <div class="col-md-8">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            ...
                            <p class="mb-0 opacity-75">
                                Saisissez le compte-rendu de la consultation
                            </p>
                        </div>
            ...
            <div class="card shadow-lg border-0 rounded-4 mb-4">
                <div class="card-body p-4">
                        ...
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <h5 class="mb-0 fw-bold">{{ $rendezVous->patient->user->name }}</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <small class="text-muted">Médecin traitant</small>
                            <p class="mb-0 fw-semibold">Dr. {{ Auth::user()->name }}</p>
                        </div>
                        <div class="col-md-6">
                            <small class="text-muted">Spécialité</small>
                            <p class="mb-0 fw-semibold">{{ Auth::user()->medecin->specialite ?? 'Généraliste' }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-lg border-0 rounded-4">
                <div class="card-header bg-white border-0 pt-4 pb-0">
                    <h4 class="mb-0 fw-bold">
                        <i class="fas fa-edit text-primary me-2"></i> Compte-rendu de consultation
                    </h4>
                </div>
                <div class="card-body p-4">
                    <form method="POST" action="{{ route('medecin.consultation.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="diagnostic" id="diagnostic" rows="3" class="form-control form-control-lg rounded-3" 
                                      placeholder="Saisissez le diagnostic..." required></textarea>
                            @error('diagnostic')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="traitement" id="traitement" rows="4" class="form-control form-control-lg rounded-3" 
                                      placeholder="Saisissez le traitement..." required></textarea>
                            @error('traitement')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" id="notes" rows="2" class="form-control form-control-lg rounded-3" 
                                      placeholder="Saisissez des notes..."></textarea>
                        </div>
