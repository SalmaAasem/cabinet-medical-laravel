...
<head>
    ...
    <style>
        ...
        .stat-label { color: #64748b; font-size: 0.8rem; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px; }
        .stat-badge { font-size: 0.7rem; padding: 2px 8px; border-radius: 20px; }
        ...
        .chart-title { font-size: 1rem; font-weight: 700; color: #1e293b; margin-bottom: 1.2rem; }
    </style>
</head>
<body>
...
<div class="main-content">
    ...
    <div class="p-4">
        ...
        <div class="row g-3 mb-4">
            <div class="col-6 col-md-3">
                <div class="stat-card">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <span class="badge bg-primary-subtle text-primary stat-badge">+{{ $nouveauxUtilisateurs }} cette semaine</span>
                    </div>
            ...
            <div class="col-6 col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-value text-dark">{{ $stats['total_patients'] }}</div>
            ...
            <div class="col-6 col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-value text-dark">{{ $stats['total_medecins'] }}</div>
            ...
            <div class="col-6 col-md-3">
                <div class="stat-card">
                    ...
                    <div class="stat-value text-dark">{{ $stats['total_rdv'] }}</div>
        ...
        <div class="row g-3 mb-4">
            <div class="col-md-4">
                <div class="stat-card d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="stat-value" style="font-size:1.5rem">{{ $stats['rdv_en_attente'] }}</div>
            ...
            <div class="col-md-4">
                <div class="stat-card d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="stat-value" style="font-size:1.5rem">{{ $stats['rdv_confirmes'] }}</div>
            ...
            <div class="col-md-4">
                <div class="stat-card d-flex align-items-center gap-3">
                    ...
                    <div>
                        <div class="stat-value" style="font-size:1.5rem">{{ $stats['rdv_annules'] }}</div>
        ...
        <div class="row g-4 mb-4">
            {{-- Line chart: RDV + Consultations sur 6 mois --}}
            <div class="col-lg-8">
            ...
            <div class="col-lg-4">
                <div class="chart-card">
                    ...
                    <div class="mt-3 d-flex flex-column gap-1">
                        @foreach($rdvStatuts as $statut => $count)
                ...
                <div class="chart-card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle mb-0">
                            ...
                            <tbody>
                                @foreach($topMedecins as $i => $medecin)
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="rounded-circle bg-primary d-flex align-items-center justify-content-center text-white fw-bold"
                                                ...
                                                {{ strtoupper(substr($medecin->user->name ?? 'M', 0, 2)) }}
                                            </div>
                                            <span class="fw-semibold">{{ $medecin->user->name ?? 'N/A' }}</span>
                                        </div>
                                    </td>
                                    <td><span class="badge bg-info-subtle text-info">{{ $medecin->specialite }}</span></td>
                                    <td class="text-center fw-bold">{{ $medecin->rendez_vous_count }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                        </table>
...
<script>
    ...
    const moisLabels     = @json(array_column($rdvParMois, 'mois'));
    const rdvData        = @json(array_column($rdvParMois, 'total'));
    const consultData    = @json(array_column($consultationsParMois, 'total'));
    const statutLabels   = @json(array_keys($rdvStatuts));
    const statutData     = @json(array_values($rdvStatuts));
    const roleLabels     = @json(array_keys($usersParRole));
    const roleData       = @json(array_values($usersParRole));
