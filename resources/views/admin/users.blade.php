    ...
    <div class="main-content">
        <div class="topbar">
            <div>
                ...
                <small class="text-muted">{{ $users->total() }} utilisateurs au total</small>
            </div>
                ...
                <form method="GET" action="{{ route('admin.users') }}" class="row g-2 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="role" class="form-select">
                            ...
                            <option value="medecin" {{ request('role') == 'medecin' ? 'selected' : '' }}>Médecin
                            </option>
                            <option value="secretaire" {{ request('role') == 'secretaire' ? 'selected' : '' }}>
                                Secrétaire</option>
                    ...
                    <div class="col-md-2">
                        <a href="{{ route('admin.users') }}" class="btn btn-outline-secondary w-100">Réinitialiser</a>
                    </div>
                </form>
            </div>
                        ...
                        <tbody class="divide-y">
                            @forelse($users as $user)
                                <tr>
                                    <td class="ps-4">
                                        <div class="d-flex align-items-center gap-3">
                                            <div class="avatar text-white"
                                                style="background: hsl({{ crc32($user->name) % 360 }}, 60%, 50%)">
                                    ...
                                    <td>
                                        <span class="role-badge role-{{ $user->role ?? 'patient' }}">
