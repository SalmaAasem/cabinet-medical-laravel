            ...
            <div class="card shadow-lg border-0 rounded-4">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <a href="{{ route('medecin.rendez-vous') }}" class="btn btn-primary w-100 py-3 rounded-3 shadow-sm" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none;">
                                <i class="fas fa-calendar-check me-2"></i> Mes consultations
                            </a>
                        </div>
                        <div class="col-md-6">
                            <a href="{{ route('medecin.patients.index') }}" class="btn btn-outline-primary w-100 py-3 rounded-3 shadow-sm">
                        ...
                        @if(Auth::user()->role == 'patient')
                        <div class="col-md-6">
                            <a href="{{ route('patient.my_history') }}" class="btn btn-primary w-100 py-3 rounded-3 shadow-sm" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none;">
                                <i class="fas fa-history me-2"></i> Mon Historique Médical
                            </a>
                        </div>
                        <div class="col-md-6">
                            <a href="{{ route('rendez-vous.index') }}" class="btn btn-outline-primary w-100 py-3 rounded-3 shadow-sm">
                        ...
                        <div class="col-md-4">
                            <a href="{{ route('patients.create') }}" class="btn btn-primary w-100 py-3 rounded-3 shadow-sm" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none;">
                                <i class="fas fa-user-plus me-2"></i> Ajouter un patient
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="{{ route('patients.index') }}" class="btn btn-primary w-100 py-3 rounded-3 shadow-sm" style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); border: none;">
                                <i class="fas fa-list me-2"></i> Liste des Patients
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="{{ route('gestion-rdv.index') }}" class="btn btn-outline-primary w-100 py-3 rounded-3 shadow-sm">
