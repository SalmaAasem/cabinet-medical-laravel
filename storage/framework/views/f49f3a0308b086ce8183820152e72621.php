    ...
    <div class="card shadow-lg border-0 rounded-4 mb-4 text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('patients.index')); ?>" class="btn btn-light rounded-pill px-4">
                ...
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="name" class="form-control border-0 bg-light p-3" value="<?php echo e(old('name', $patient->user->name)); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="telephone" class="form-control border-0 bg-light p-3" value="<?php echo e(old('telephone', $patient->telephone)); ?>" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="input-group">
                            ...
                            <input type="date" name="date_naissance" class="form-control border-0 bg-light p-3" value="<?php echo e(old('date_naissance', $patient->date_naissance)); ?>" required>
                        </div>
                    </div>

                    <div class="col-md-12">
                        <label class="form-label fw-bold text-muted small uppercase">Adresse Résidentielle</label>
                        <textarea name="adresse" rows="3" class="form-control border-0 bg-light p-3" required><?php echo e(old('adresse', $patient->adresse)); ?></textarea>
                    </div>
...
<?php echo $__env->make('layouts.simple', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pc\Downloads\cabinet-medical-laravel\cabinet-medical-laravel\resources\views/patients/edit.blade.php ENDPATH**/ ?>