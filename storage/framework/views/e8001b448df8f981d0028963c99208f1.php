    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="info-box">
                ...
                <ul>
                    <li>👨‍⚕️ Médecin : Dr. <?php echo e($rdv->medecin->user->name); ?></li>
                    <li>🕒 Heure : <?php echo e(\Carbon\Carbon::parse($rdv->date_heure)->format('H:i')); ?></li>
                </ul>
            </div>
...
</html><?php /**PATH C:\Users\pc\Downloads\cabinet-medical-laravel\cabinet-medical-laravel\resources\views/emails/reminder.blade.php ENDPATH**/ ?>