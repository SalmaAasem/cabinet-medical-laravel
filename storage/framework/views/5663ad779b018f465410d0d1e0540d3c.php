                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="fw-semibold"><?php echo e($patient->user->name); ?></div>
                                </td>
                                ...
                                <td>
                                    <a href="<?php echo e(route('gestion-rdv.index')); ?>" class="btn btn-sm btn-outline-primary rounded-3">
...
<?php echo $__env->make('layouts.simple', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cabinet-medical-laravel\resources\views/secretaire/patients.blade.php ENDPATH**/ ?>