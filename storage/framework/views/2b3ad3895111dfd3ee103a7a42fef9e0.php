...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Félicitations <strong><?php echo e($rdv->patient->user->name); ?></strong>,</p>
            ...
            <div class="info-box">
                ...
                <h3 style="margin: 5px 0;"><?php echo e(\Carbon\Carbon::parse($rdv->date_heure)->format('d/m/Y à H:i')); ?></h3>
                <p style="margin: 0; font-size: 14px;">Cabinet Médical - Dr. <?php echo e($rdv->medecin->user->name); ?></p>
            </div>
            
            <p>Veuillez vous présenter 10 minutes avant l'heure prévue. Si vous avez un empêchement, merci de nous prévenir.</p>
        </div>
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> Cabinet Médical - Votre santé est notre priorité.</p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\pc\Downloads\cabinet-medical-laravel\cabinet-medical-laravel\resources\views/emails/confirmed_by_admin.blade.php ENDPATH**/ ?>