...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Bonjour <strong><?php echo e($rdv->patient->user->name); ?></strong>,</p>
            ...
            <div class="info-box">
                ...
                <ul style="list-style: none; padding: 0;">
                    <li> Médecin : Dr. <?php echo e($rdv->medecin->user->name); ?></li>
                    <li> Date : <?php echo e(\Carbon\Carbon::parse($rdv->date_heure)->format('d/m/Y H:i')); ?></li>
                </ul>
            </div>
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> Cabinet Médical - Tous droits réservés.</p>
        </div>
    </div>
</body>
</html><?php /**PATH C:\Users\pc\Downloads\cabinet-medical-laravel\cabinet-medical-laravel\resources\views/emails/confirmation.blade.php ENDPATH**/ ?>