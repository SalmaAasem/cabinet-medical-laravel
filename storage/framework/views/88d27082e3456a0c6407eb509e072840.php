...
<div class="container mt-4">
    ...
    <div class="card shadow-lg border-0 rounded-4 mb-4">
        <div class="card-body p-4">
            <form method="GET" action="<?php echo e(route('patients.search')); ?>" class="row g-3">
                <div class="col-md-10">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="<?php echo e(route('patients.edit', $patient->id)); ?>" class="btn btn-sm btn-warning rounded-3">
                                            <i class="fas fa-edit"></i> Modifier
                                        </a>

                                        <a href="<?php echo e(route('patients.historique', $patient->id)); ?>" class="btn btn-sm btn-info rounded-3">
    ...
    <div class="text-center mt-4">
        <a href="<?php echo e(route('patients.create')); ?>" class="btn btn-primary btn-lg px-5 rounded-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none;">
            <i class="fas fa-user-plus me-2"></i> Ajouter un patient
        </a>
    </div>
</div>
...
<?php echo $__env->make('layouts.simple', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cabinet-medical-laravel\resources\views/patients/index.blade.php ENDPATH**/ ?>