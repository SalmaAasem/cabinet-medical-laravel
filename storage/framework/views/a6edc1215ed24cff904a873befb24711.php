                ...
                <form method="GET" action="<?php echo e(route('admin.users')); ?>" class="row g-2 align-items-end">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="role" class="form-select">
                            ...
                            <option value="admin" <?php echo e(request('role') == 'admin' ? 'selected' : ''); ?>>Administrateur
                            </option>
                            <option value="medecin" <?php echo e(request('role') == 'medecin' ? 'selected' : ''); ?>>Médecin
                            </option>
                            <option value="secretaire" <?php echo e(request('role') == 'secretaire' ? 'selected' : ''); ?>>
                                Secrétaire</option>
                            <option value="patient" <?php echo e(request('role') == 'patient' ? 'selected' : ''); ?>>Patient
                            </option>
                        </select>
                    </div>
                    <div class="col-md-2">
...
<?php /**PATH C:\Users\pc\Downloads\cabinet-medical-laravel\cabinet-medical-laravel\resources\views/admin/users.blade.php ENDPATH**/ ?>