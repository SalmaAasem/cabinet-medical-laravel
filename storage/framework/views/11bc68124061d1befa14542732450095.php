...
<div class="container mt-4">
        ...
        <div class="card-body p-4">
            <?php if($rendezVous->isEmpty()): ?>
                <div class="text-center text-muted py-5">
                    ...
                    <a href="<?php echo e(route('rendez-vous.create')); ?>" class="btn btn-primary mt-3 rounded-3">
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="fw-semibold">Dr. <?php echo e($rdv->medecin->user->name); ?></div>
                                    <small class="text-muted"><?php echo e($rdv->medecin->specialite); ?></small>
                                </td>
                                <td>
                                    <div><?php echo e(\Carbon\Carbon::parse($rdv->date_heure)->format('d/m/Y')); ?></div>
                                    <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($rdv->date_heure)->format('H:i')); ?></small>
                                </td>
                                <td>
                                    <span class="badge bg-secondary rounded-pill px-3 py-2">
                                        <i class="fas fa-notes-medical me-1"></i> <?php echo e($rdv->motif ?? 'Non spécifié'); ?>
                                ...
                                <td>
                                    <?php if($rdv->statut == 'en_attente'): ?>
                                    <form method="POST" action="<?php echo e(route('rendez-vous.destroy', $rdv->id)); ?>" onsubmit="return confirm('Annuler ce rendez-vous ?')">
                                        <?php echo csrf_field(); ?>
    ...
    <div class="text-center mt-4">
        <a href="<?php echo e(route('rendez-vous.create')); ?>" class="btn btn-primary btn-lg px-5 rounded-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none;">
...
<?php echo $__env->make('layouts.simple', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cabinet-medical-laravel\resources\views/rendezvous/index.blade.php ENDPATH**/ ?>