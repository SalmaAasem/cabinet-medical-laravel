        ...
        <div class="col-12">
            <div class="card shadow-lg border-0 rounded-4 text-white" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
                <div class="card-body p-4">
                    ...
                    <a href="<?php echo e(route('medecin.rendez-vous')); ?>" class="btn btn-light rounded-pill px-4 shadow fw-bold position-absolute" 
                        ...
                        <tr>
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <h6 class="mb-0 fw-bold"><?php echo e($patient->user->name); ?></h6>
                                </div>
                            </td>
                            <td><?php echo e($patient->user->email); ?></td>
                            <td class="text-end">
                                <a href="<?php echo e(route('medecin.patient.history', $patient->id)); ?>" class="btn btn-primary rounded-pill px-4">
...
<?php echo $__env->make('layouts.simple', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\pc\Downloads\cabinet-medical-laravel\cabinet-medical-laravel\resources\views/medecin/patients_list.blade.php ENDPATH**/ ?>