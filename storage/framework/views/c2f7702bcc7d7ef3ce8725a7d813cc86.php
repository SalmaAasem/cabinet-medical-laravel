                ...
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('rendez-vous.store')); ?>">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="medecin_id" id="medecin_id" class="form-select form-select-lg rounded-3 <?php $__errorArgs = ['medecin_id'];
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <?php $__currentLoopData = $medecins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medecin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($medecin->id); ?>">
                                        Dr. <?php echo e($medecin->user->name ?? 'Nom inconnu'); ?> - <?php echo e($medecin->specialite ?? 'Généraliste'); ?>

                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <?php $__errorArgs = ['medecin_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="datetime-local" name="date_heure" id="date_heure" class="form-control form-control-lg rounded-3 <?php $__errorArgs = ['date_heure'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="d-flex gap-3 mt-4">
                            <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline-secondary btn-lg px-4 rounded-3 flex-grow-1">
...
<?php echo $__env->make('layouts.simple', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\cabinet-medical-laravel\resources\views/rendezvous/create.blade.php ENDPATH**/ ?>