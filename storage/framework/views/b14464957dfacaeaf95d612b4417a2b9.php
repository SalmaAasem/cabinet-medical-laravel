            ...
            <div class="col-6 col-md-3">
                <div class="stat-card">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <span class="badge bg-primary-subtle text-primary stat-badge">+<?php echo e($nouveauxUtilisateurs); ?> cette semaine</span>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class="fw-semibold"><?php echo e($medecin->user->name ?? 'N/A'); ?></span>
                                        </div>
                                    </td>
                                    <td><span class="badge bg-info-subtle text-info"><?php echo e($medecin->specialite); ?></span></td>
...
</html><?php /**PATH C:\xampp\htdocs\cabinet-medical-laravel\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>